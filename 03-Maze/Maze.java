...
public class Maze{
  ...
  */
  ...
  public void setAnimate(boolean b){import java.util.*;
import java.io.*;
public class Maze{
  private char[][] maze;
  private boolean animate;//false by default
  ...
  */
  ...
  public Maze(String filename) throws FileNotFoundException{
    ...
    //   }
    // }
    // if(!s || !e){throw new FileNotFoundException("Missing a start or an end"); }
  }
  ...
  */
  ...
  public int solve(){
    int x = -1, y = -1;
    for(int i = 0; i < maze.length; i++){
      for(int j = 0; j < maze[0].length; j++){import java.util.*;
import java.io.*;
public class Maze{
  private char[][] maze;
  private boolean animate;//false by default
